...
public interface ReviewDAO {
	...
	public Review findByReview (Connection con, Long userId, Long bookId) 
			throws DataException;
	
	public Results<Review> findByUser (Connection con, Long userId, int pos, int pageSize)
			throws DataException;
	
	public Results<Review> findByBook (Connection con, Long bookId, int pos, int pageSize)
			throws DataException;
